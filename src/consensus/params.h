...
struct Params {
    ...
    int nAvgFeeStartBlock = 619480;
    int nAvgFeeStartBlockRevert = 626550;
    int nAvgFeeStartBlockV2 = 682240;
    int DEV_FUND_BLOCK_HEIGHT = 1655000; // Developers Fund block height
